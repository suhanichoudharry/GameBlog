    ...
    create: (context) => {
        ...
        return {
            CallExpression(node) {
                ...
                if (memberExpr.property.type !== types_1.AST_NODE_TYPES.Identifier) {
                    return;
                }
                ...
                const isCtxDb = memberExpr.object.type === types_1.AST_NODE_TYPES.MemberExpression &&
                    memberExpr.object.property.type === types_1.AST_NODE_TYPES.Identifier &&
