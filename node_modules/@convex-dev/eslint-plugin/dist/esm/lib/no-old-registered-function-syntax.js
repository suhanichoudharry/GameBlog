...
export const noOldRegisteredFunctionSyntax = createRule({
    ...
    meta: {
        type: "suggestion",
        docs: {
            description: "Don't use the non-object Convex function syntax. It's harder to add validation rules.",
        },
        messages: {
            "use-object-syntax": "Use the object syntax for registered Convex queries, mutations, and actions.",
        },
        schema: [],
        fixable: "code",
    },
                ...
                if (node.init?.type === "CallExpression" &&
                    ...
                    context.report({
                        ...
                        fix: (fixer) => {
                            ...
                            const originalFunctionText = context.sourceCode.getText(functionArg);
...
//# sourceMappingURL=no-old-registered-function-syntax.js.map